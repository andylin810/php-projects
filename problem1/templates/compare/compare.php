<div class="left-container">
    <?php
        ...
        session_start();
        $_SESSION['left-db-button'] = 'select-database';
...
<div class="right-container">
    ...
    <div class='table-form'>
        ...
        <form id='save-upload-form' enctype="multipart/form-data" action='templates/compare/quick_save_upload_table.php' method='post'>
            <label for="">upload file:</label>
            <input type="file" name="upload-file" value="upload-file" class="upload-file">
    ...
    <form action="templates/compare/generate_file.php" method="get">
